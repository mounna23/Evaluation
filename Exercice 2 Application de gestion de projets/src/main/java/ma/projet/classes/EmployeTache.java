...
public class EmployeTache {
    ...
    @ManyToOne
    @JoinColumn(name = "employe_id") // Changé de "employee_id" à "employe_id"
    private Employe employe; // Changé de "Employee" à "Employe"
    ...
    public Employe getEmploye() { return employe; } // Changé de getEmployee à getEmploye
    public void setEmploye(Employe employe) { this.employe = employe; } // Changé de setEmployee à setEmploye
